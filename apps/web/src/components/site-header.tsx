  ...
  return (
    <>
      <div className="beta-banner">
        PumpNow beta is live on {networkName}. Trade responsibly.{" "}
        <span>→</span>
      </div>
      <header className="site-header">
        <Link href="/" className="mobile-brand">
          <span className="brand-mark">P</span>PumpNow
        </Link>
        <form className="top-search" onSubmit={submit}>
          ...
          <input
            ...
            placeholder="Search for tokens and addresses..."
            aria-label="Search PumpNow"
          />
          <kbd>⌘ K</kbd>
        </form>
