import type { Candle, CandleInterval, Holder, Paginated, PlatformStats, Portfolio, TokenDetail, TokenSort, TokenSummary, Trade } from "./types";
...
export const api = {
  tokens: (sort: TokenSort, limit = 12) => request<Paginated<TokenSummary>>(`/api/tokens?sort=${sort}&page=1&limit=${limit}`),
